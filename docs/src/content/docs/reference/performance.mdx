...
You can use the research results to find what languages are most important to include for specific translation pairs. This is shown in our [paper](https://arxiv.org/abs/2411.01063). The higher the CA Decrease (%) in the Figure below, the more important it is keeping that language as intermediate. 
