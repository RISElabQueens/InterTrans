...
Configuring InterTrans can be done through the [.yaml configuration file](/InterTrans/reference/config/). Additionally, you need to specify the paths to the container images for the target languages you want to translate to. This guide will walk you through the steps to configure InterTrans.
...
<Steps>
    ...
    3. Update the configuration file with the paths to the container images. For example, if you were to add Python and Java executors, your configuration file could look like this:
        ...
        ```
        You can find more information on the configuration file in the [Server Configuration](/InterTrans/reference/config/) guide.
</Steps>

<Aside type='tip'>Have you created an executor image for other languages or environments? Please consider contributing by adding it to this page! [Learn how to contribute](/InterTrans/guides/contribute)</Aside>
