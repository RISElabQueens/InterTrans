...
A: Yes, you can use the InterTrans Engine to do direct translation. Setting ```expansionIntermediaryNodes: 1``` in the [Server Configuration](/reference/config) would be equivalent to performing Direct Translation.
