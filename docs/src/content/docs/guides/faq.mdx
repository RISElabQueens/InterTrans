...
A: Yes, you can use the InterTrans Engine to do direct translation. Setting ```expansionIntermediaryNodes: 1``` in the [Server Configuration/InterTrans/reference/e/config) would be equivalent to performing Direct Translation.

## Q: What languages are supported?
A: InterTrans currently supports the following target languages: Python, Java, C, C++, JavaScript, TypeScript, and Go. We are working on adding support for more languages.
